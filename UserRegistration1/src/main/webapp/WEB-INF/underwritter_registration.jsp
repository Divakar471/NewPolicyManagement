...
<body>
<form action="addUnderwritter" style="border:1px solid #ccc" method="post">
  <div class="container">
    <h1>UnderWritter Registration</h1>
    <p>Please fill this form to register as UnderWritter.</p>
    <hr>
